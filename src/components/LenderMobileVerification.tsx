...
const LenderMobileVerification = () => {
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center">
                        ...
                        <div className="mt-5 flex justify-center items-center">
                            <button
                                ...
                                className={`relative flex items-center px-6 py-2 rounded-[2px] transition duration-100 ease-in-out text-white 
                            ...
                            >
                                Continue <GoChevronRight className="ml-2 text-[#fff] text-xl" />
                            </button>
                        </div>
                    </form>
                ...
                <div className="w-full h-full flex flex-col items-center justify-center px-5 md:px-12">
                    <div className="max-w-[300px]">
                        ...
                        <div className="mt-5 flex justify-center items-center mb-4">
                            ...
                            >
                                Verify OTP <GoChevronRight className="ml-2 text-[#fff] text-xl" />
                            </button>
                        </div>
...
export default LenderMobileVerification;